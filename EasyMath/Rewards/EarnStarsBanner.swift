        ...
        ZStack {
            ...
            HStack {
                ...
                Image("gift")
                    .resizable()
                    .scaledToFit()
                    .frame(width: isSmallScreen ? 90 : 100)
                    .padding(.trailing, 20)
                ...
                VStack(alignment: .leading, spacing: 5) {
                    Text("Need more stars?")
                        ...
                        .font(Font.system(size: isSmallScreen ? 17 : 18, weight: .bold, design: .rounded))
                    
                    Text("Earn stars by solving math\nproblems and collect fun\nrewards.")
                        .foregroundStyle(Color(red: 48/255, green: 47/255, blue: 89/255))
                        .font(Font.system(size: isSmallScreen ? 14 : 15, weight: .medium, design: .rounded))
                        .padding(.trailing, 10)
                }
            }
        }
...
#Preview {
    EarnStarsBanner(isSmallScreen: true)
}
